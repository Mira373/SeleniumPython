...
#Perform Right Click & Double Click
...
class DemoMouseActions:
    def mouse_actions(self):
        ...
        actions.context_click(nav_button).perform() #right click --> mouse menu
        actions.double_click(nav_button).perform()  #Double-clicks an element
        time.sleep(10)
